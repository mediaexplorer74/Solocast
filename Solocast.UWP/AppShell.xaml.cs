    ...
    public sealed partial class AppShell : Page
    {
        ...
        private void OnNavigatingToPage(object sender, NavigatingCancelEventArgs e)
        {
            if (e.NavigationMode == NavigationMode.Back)
            {
                ...
                ListViewItem container = (ListViewItem)NavMenuList.ContainerFromItem(item);
        ...
        private void CheckTogglePaneButtonSizeChanged()
        {
                ...
                this.RootSplitView.DisplayMode == SplitViewDisplayMode.Overlay)
            {
                ...
                var rect = transform.TransformBounds(
                    new Rect(0, 0, this.TogglePaneButton.ActualWidth, 
        ...
        private void NavMenuItemContainerContentChanging(ListViewBase sender,
            ContainerContentChangingEventArgs args)
        {
            if (!args.InRecycleQueue && args.Item != null && args.Item is NavMenuItem)
            {
                args.ItemContainer.SetValue(AutomationProperties.NameProperty, 
                    ((NavMenuItem)args.Item).Label);
            }
            else
            {
